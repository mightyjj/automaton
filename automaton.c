...
Signed by: LIM JUN JIE (STUDENT ID: 1228915)
...
void
make_FirstRun(automaton_t *automaton) {
...
void
make_node(automaton_t *automaton, node_t *node, char *c) {
    strcpy(node->str, c);
...
void
make_state(automaton_t *automaton, state_t *state) {
...
automaton_t
*make_EmptyAutomaton(automaton_t *automaton) {
